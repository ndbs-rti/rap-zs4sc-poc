interface ZDEMOEVENTIF_SALESORDER_I_84CE
  public .
  ...
  types:
    TY_S_SALESORDER_ITMDELIVS_0FC5 TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Itm_EB77 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_itmdelivs_0FC5
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
