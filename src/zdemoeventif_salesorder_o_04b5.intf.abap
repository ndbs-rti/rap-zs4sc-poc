interface ZDEMOEVENTIF_SALESORDER_O_04B5
  public .
  ...
  types:
    TY_S_SALESORDER_OVRLSDPRO_894B TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Ovr_601F .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_ovrlsdpro_894B
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
