interface ZDEMOEVENTIF_SALESORDER_I_E5AB
  public .
  ...
  types:
    TY_S_SALESORDER_ITEMCREATED_V1 TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Ite_C962 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_itemcreated_v1
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
