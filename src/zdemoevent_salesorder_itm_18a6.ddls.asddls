@EndUserText.label: 'ZDEMOEVENT_SalesOrder_Itm_18A6 generated'
define root abstract entity ZDEMOEVENT_SalesOrder_Itm_18A6
{
  @Event.element.externalName: 'DeliveryBlockStatus'
  DeliveryBlockStatus : abap.strg;
  ...
  @Event.element.externalName: 'PreviousDeliveryBlockStatus'
  PreviousDeliveryBlockStatus : abap.strg;
