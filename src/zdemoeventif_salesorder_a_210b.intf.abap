interface ZDEMOEVENTIF_SALESORDER_A_210B
  public .
  ...
  types:
    TY_S_SALESORDER_APPROVALS_2E1B TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_App_CCB8 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_approvals_2E1B
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
