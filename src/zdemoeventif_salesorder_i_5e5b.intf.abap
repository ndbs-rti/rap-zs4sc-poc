interface ZDEMOEVENTIF_SALESORDER_I_5E5B
  public .
  ...
  types:
    TY_S_SALESORDER_ITMDLVCON_736C TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Itm_BC91 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_itmdlvcon_736C
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
