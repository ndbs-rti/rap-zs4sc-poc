interface ZDEMOEVENTIF_SALESORDER_C_A85B
  public .
  ...
  types:
    TY_S_SALESORDER_CHANGED_V1 TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Cha_4E00 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_changed_v1
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
