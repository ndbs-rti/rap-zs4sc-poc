interface ZDEMOEVENTIF_SALESORDER_T_9D41
  public .
  ...
  types:
    TY_S_SALESORDER_TOTCRDTCH_78A5 TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Tot_E45D .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_totcrdtch_78A5
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
