interface ZDEMOEVENTIF_SALESORDER_I_F1B2
  public .
  ...
  types:
    TY_S_SALESORDER_ITMPRFTCT_CFE5 TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Itm_81BD .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_itmprftct_CFE5
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
