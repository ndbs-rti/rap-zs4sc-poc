interface ZDEMOEVENTIF_SALESORDER_I_21E6
  public .
  ...
  types:
    TY_S_SALESORDER_ITEMCHANGED_V1 TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Ite_F515 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_itemchanged_v1
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
