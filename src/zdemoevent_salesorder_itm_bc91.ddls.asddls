@EndUserText.label: 'ZDEMOEVENT_SalesOrder_Itm_BC91 generated'
define root abstract entity ZDEMOEVENT_SalesOrder_Itm_BC91
{
  @Event.element.externalName: 'DeliveryConfirmationStatus'
  DeliveryConfirmationStatus : abap.strg;
  ...
  @Event.element.externalName: 'PreviousDeliveryConfStatus'
  PreviousDeliveryConfStatus : abap.strg;
