interface ZDEMOEVENTIF_SALESORDER_I_4254
  public .
  ...
  types:
    TY_S_SALESORDER_ITMBILLGB_5BB4 TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Itm_37B7 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_itmbillgb_5BB4
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
