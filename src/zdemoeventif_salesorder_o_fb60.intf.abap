interface ZDEMOEVENTIF_SALESORDER_O_FB60
  public .
  ...
  types:
    TY_S_SALESORDER_OVRLBLGBL_35A6 TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Ovr_1CD3 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_ovrlblgbl_35A6
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
