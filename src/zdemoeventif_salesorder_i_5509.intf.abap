interface ZDEMOEVENTIF_SALESORDER_I_5509
  public .
  ...
  types:
    TY_S_SALESORDER_ITMGENINC_9C98 TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Itm_A0DA .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_itmgeninc_9C98
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
