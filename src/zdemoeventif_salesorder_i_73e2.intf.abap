interface ZDEMOEVENTIF_SALESORDER_I_73E2
  public .
  ...
  types:
    TY_S_SALESORDER_ITMWBSELM_80D3 TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Itm_BC28 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_itmwbselm_80D3
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
