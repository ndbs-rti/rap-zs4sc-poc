@EndUserText.label: 'ZDEMOEVENT_SalesOrder_Itm_A0DA generated'
define root abstract entity ZDEMOEVENT_SalesOrder_Itm_A0DA
{
  ...
  @Event.element.externalName: 'ItemGeneralIncompletionStatus'
  ItemGeneralIncompletionStatus : abap.strg;
  @Event.element.externalName: 'OrganizationDivision'
  OrganizationDivision : abap.strg;
  @Event.element.externalName: 'PreviousItmGenIncompltnSts'
  PreviousItmGenIncompltnSts : abap.strg;
