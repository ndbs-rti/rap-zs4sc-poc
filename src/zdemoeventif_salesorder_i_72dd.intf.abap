interface ZDEMOEVENTIF_SALESORDER_I_72DD
  public .
  ...
  types:
    TY_S_SALESORDER_ITMRJCNST_275E TYPE STRUCTURE FOR HIERARCHY ZDEMOEVENT_SalesOrder_Itm_A3C5 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salesorder_itmrjcnst_275E
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
